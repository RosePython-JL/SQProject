...
public class Graph extends JLabel implements ComponentListener, EquationListener {
    ...
    private static final Color[] lineColours = {
            new Color(231, 76, 60),
    ...
    protected void drawGrid(Graphics2D g) {
        ...
        g.draw(new Line2D.Double(0, this.img.getHeight() / 2f,
                                 this.img.getWidth(), this.img.getHeight() / 2f));
        g.draw(new Line2D.Double(this.img.getWidth() / 2f, 0,
                                 this.img.getWidth() / 2f, this.img.getHeight()));
